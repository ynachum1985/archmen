                ...
                <div className="flex items-center gap-2">
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                      <DialogHeader>
                        <DialogTitle>📚 How to Use Assessment Content Preprocessing & Testing</DialogTitle>
                        <DialogDescription>
                          Simple steps to optimize your assessment knowledge base
                        </DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div className="p-4 bg-blue-50 rounded-lg">
                          ...
                          <div className="text-sm text-blue-800 space-y-1">
                            ...
                            <div>✅ Assessment-specific metadata</div>
                        ...
                        <div className="p-4 bg-green-50 rounded-lg">
                          ...
                          <div className="text-sm text-green-800 space-y-1">
                            <div>1. Add content in the Knowledge Base section above</div>
                            ...
                            <div>4. View processed chunks in content display</div>
                          </div>
                        </div>
