...
interface InlineHomeworkViewProps {
  userId: string
  currentAssessmentId?: string
}

export function InlineHomeworkView({ userId, currentAssessmentId }: InlineHomeworkViewProps) {
  ...
  const loadHomeworkData = async () => {
    try {
      ...
      // Build query for homework tasks
      ...
      // Filter by assessment if one is selected
